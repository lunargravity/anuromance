    ...
    <div className="second-row">
      <div className="custom-container">
        ...
        <div className="samples">
          <Icon
            href="google.com"
            src={`${basePath}/thirdtimesthecharm.png`}
            alt="Weight Icon"
          />
          <Icon
            href="google.com"
            src={`${basePath}/boilingpot.png`}
            alt="Chef Hat Icon"
          />
          <Icon
            href="google.com"
            src={`${basePath}/troublewithlynn.png`}
            alt="Injured Icon"
          />
          <Icon
            href="google.com"
            src={`${basePath}/nolongerinnocent.png`}
            alt="Dancing Couple Icon"
          />
        </div>
      </div>
    </div>
